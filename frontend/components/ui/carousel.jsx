...
const Carousel = React.forwardRef(
  (
    ...
    // Handle click on the carousel for desktop navigation
    const handleClick = React.useCallback(
      (event) => {
        const { clientX, currentTarget } = event;
        const targetWidth = currentTarget.offsetWidth;

        // Click left side to scrollPrev, right side to scrollNext
    ...
    return (
      ...
      >
        <div
          ...
          onClick={handleClick} // Handle desktop click navigation
          role="region"
